$(document).ready(function() {
    ...
    $('#fullpage').fullpage({
      onLeave: function(index, nextIndex, direction){
      		$('#breadcrumbBar').css('display', 'table');
	         if (nextIndex == 1) {
				$('#introSectionWrapper').hide();			         	
	         }
			...
			//animate sidebar
			$('#sidebar' + index).removeClass('showSidebar').addClass('hideSidebar');
	 		$('#sidebar' + nextIndex).removeClass('hideSidebar').addClass('showSidebar');
